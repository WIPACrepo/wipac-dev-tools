...
echo "╠═══════════════════════════════════════════════════════════════════════════╣"
echo "║  Host Info:                                                               ║"
echo "║    - Hostname:  $(printf '%-58s' "$(hostname)")║"
...
echo "║  Docker version: $(printf '%-57s' "$(docker --version | head -n1)")║"
echo "║  Network:        $(printf '%-57s' "$DOCKER_NETWORK_NAME")║"
echo "║  Timestamp:      $(printf '%-57s' "$(date -u +"%Y-%m-%dT%H:%M:%S.%3NZ")")║"
echo "╚═══════════════════════════════════════════════════════════════════════════╝"
echo
