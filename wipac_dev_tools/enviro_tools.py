...
from . import logging_tools, typing_tools
...
def _from_environment_as_dataclass(
    ...
    for field in dataclasses.fields(dclass):
        ...
        try:
            typ, arg_typs = typing_tools.reduce_type(field.type)
        except typing_tools.BareSpecialFormReductionError as e:
            raise ValueError(
        ...
        except typing_tools.AnyTypeReductionError as e:
            raise ValueError(
                f"'{field.type}' is not a supported type: "
